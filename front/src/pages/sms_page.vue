...
<template>
  <q-page>
    <q-table 
      ...
      <template v-slot:top="props">
        ...
        <div class="col-3 q-table__title">sms</div>
  ...
  <GridOptionsEditor ref="GridOptionsView"
      ...
      :columns="columns" optionName="smspage">
  </GridOptionsEditor>
  <ObjectDisplay ref="object_display">
  </ObjectDisplay>
  <SmsEdit ref="edit_form" @hide="refresh_grid()" @ok="refresh_grid()">
  </SmsEdit>
  <SmsInsert ref="insert_form" @hide="refresh_grid()" @ok="refresh_grid()">
  </SmsInsert>
...
import SmsEdit from 'src/components/forms/SmsEdit.vue'
import SmsInsert from 'src/components/forms/SmsInsert.vue'
...
export default {
  ...
  setup(props) {
    ...
    function delete_row() {
      api.delete('/sms/' + delete_row_id.value)
      .then(response=>{
        refresh_grid()
      })
    }
